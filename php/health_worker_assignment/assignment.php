            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        ...
                        <a href="create.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New Assignment</a>
                    </div>
                    <?php
                    // Include config file
                    ...
                    if ($result = mysqli_query($link, $sql)) {
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                echo '<a href="update.php?person_id=' . $row['person_id'] .'&facility_name=' . $row['facility_name'] . '" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
