                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" name="vaccine_name"
                               class="form-control <?php echo (!empty($vaccine_name_error)) ? 'is-invalid' : '' ?>"
                               value="<?php echo $vaccine_name; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="approval"
                               class="form-control <?php echo (!empty($approval_error)) ? 'is-invalid' : '' ?>"
                               value="<?php echo $approval; ?>">
                        <span class="invalid-feedback"><?php echo $approval_error; ?></span>
                    </div>

                    <div class="form-group">
                        <label>Suspension Date</label>
                        <input type="date" name="suspension"
                               class="form-control <?php echo (!empty($suspension_error)) ? 'is-invalid' : ''; ?>"
                               value="<?php echo $suspension; ?>">
                        <span class="invalid-feedback"><?php echo $suspension_error; ?></span>
                    </div>

                    <input type="submit" class="btn btn-primary" value="Submit">
                    <a href="vaccineType.php" class="btn btn-secondary ml-2">Cancel</a>
                </form>
            </div>
        </div>
    </div>
