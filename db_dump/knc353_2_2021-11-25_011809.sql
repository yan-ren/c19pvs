...
INSERT INTO `covid` VALUES (1,'unknown','D'),(2,'Beta','A'),(3,'Gamma','A'),(4,'Delta','A'),(5,'MU','A'),(6,'Alpha','A'),(7,'venom','A'),(8,'unknown','D'),(9,'invulnerable','A');
...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT='This table maintains the registration of public health care workers with public health care system';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `vaccine` VALUES ('AstraZeneca','suspend',NULL,NULL,'2020-09-25'),('CanaVax','safe',1,'2021-10-08',NULL),('Covax','safe',2,'2020-10-15',NULL),('Diaozha','safe',2,'2020-11-12',NULL),('Gam-COVID-Vac','suspend',2,NULL,'2020-09-25'),('Johnson&Johnson','suspend',1,NULL,'2021-01-20'),('Moderna','safe',2,'2020-11-10',NULL),('Niubi','safe',1,'2021-11-10',NULL),('NovaVac','suspend',2,NULL,'2020-10-15'),('Pfizer','safe',2,'2020-10-23',NULL),('QCVax','suspend',1,NULL,'2021-09-09'),('SputnikV','suspend',2,NULL,'2020-10-14'),('SuperVenom','safe',2,NULL,NULL),('Venom','suspend',2,'2019-10-22','2020-10-20');
...
-- Dump completed on 2021-11-25  1:18:42
