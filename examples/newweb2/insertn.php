...
<td colspan="2" align="center"><h1>非 预 约 接 种 登 记</h1></td>
</tr>
<tr>
<td width="586"><a href="indexn.php">查看</a> | <a href="insertn.php">添加登记</a></td>
</tr>
...
<p><span>其护照号码<input name="name1" type="text" id="name1" size="40" value="zhang">*</span>名字<input name="name2" type="text" id="name2" size="40" value="666">*</p>
<p><span>姓氏<input name="name3" type="text" id="name3" size="40" value="1">*</span>中间名首字母<input name="name4" type="text" id="name4" size="40" value="1356868">*</p>
<p><span>出生日期<input name="name5" type="text" id="name5" size="40" value="2021-11-10 23:32:54 ">*</span>电话号码<input name="name6" type="text" id="name6" size="40" value="">*</p>
<p><span>地址<input name="name7" type="text" id="name7" size="40" value="">*</span>城市<input name="name8" type="text" id="name8" size="40" value="">*</p>
...
<p><span>国籍<input name="name11" type="text" id="name11" size="40" value="">*</span>电子邮件地址<input name="name12" type="text" id="name12" size="40" value="">*</p>
