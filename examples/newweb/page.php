	...
	*/
	class Page {
		...
		private function goPage(){
    			if($this->pageNum > 1) {
				return '<input type="text" style="width:15px;height:13px !important;height:10px;border:1px solid #CCCCCC;" id="idv"  value="1" onchange="javascript: var x =this.value;document.getElementById(\'idp\').href=\''.$this->uri.'page=\'+x;" ><a id="idp" ><input  type="button" style=."cursor:pointer;width:25px;height:23px;border:1px solid #CCCCCC;"  value="GO"></a>';
			}
		}
